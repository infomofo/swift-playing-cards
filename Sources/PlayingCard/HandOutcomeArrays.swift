...
struct HandOutcomeArrays {
    ...
    /// High-performance overload of payout that uses UnsafePointers and precomputed
    /// card row pointers to avoid array bounds checking and stride multiplications.
    @inline(__always)
    func payout(
