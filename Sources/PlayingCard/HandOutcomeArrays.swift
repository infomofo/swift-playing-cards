...
struct HandOutcomeArrays {
    ...
    /// High-performance overload of payout that uses precalculated row pointers for each card
    /// to eliminate 83+ million stride multiplications inside the 32-mask inner loop.
    @inline(__always)
    func payout(
