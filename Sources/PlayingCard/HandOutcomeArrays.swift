...
struct HandOutcomeArrays {
    ...
    /// High-performance overload of payout that uses UnsafePointers and pre-offset card row pointers
    /// to avoid array bounds checking and redundant stride multiplications.
    @inline(__always)
    func payout(
