...
struct HandOutcomeArrays {
    ...
    /// High-performance overload of payout that uses precomputed card row pointers (r0...r4)
    /// to avoid per-card stride multiplications and array bounds checking.
    @inline(__always)
    func payout(
    ...
    // swiftlint:enable cyclomatic_complexity function_parameter_count identifier_name
