...
struct HandOutcomeArrays {
    ...
    static func build(wildcardRank: Rank?) -> HandOutcomeArrays {
        ...
        scoreForFiveCardHand.withUnsafeMutableBufferPointer { scoreBuf in
            ...
            countsForFourHeld.withUnsafeMutableBufferPointer { counts4Buf in
                let counts4Ptr = counts4Buf.baseAddress!
                countsForThreeHeld.withUnsafeMutableBufferPointer { counts3Buf in
                    let counts3Ptr = counts3Buf.baseAddress!
                    countsForTwoHeld.withUnsafeMutableBufferPointer { counts2Buf in
                        let counts2Ptr = counts2Buf.baseAddress!
                        countsForOneHeld.withUnsafeMutableBufferPointer { counts1Buf in
                            let counts1Ptr = counts1Buf.baseAddress!
                            countsForNoneHeld.withUnsafeMutableBufferPointer { counts0Buf in
                                let counts0Ptr = counts0Buf.baseAddress!
                                            ...
                                            for c2 in (c1 + 1) ..< 52 {
                                                ...
                                                for c3 in (c2 + 1) ..< 52 {
                                                    ...
                                                    for c4 in (c3 + 1) ..< 52 {
                                                        ...
                                                        counts4Ptr[idx4_0 * n + score] += 1

                                                        let idx4_1 = chooseC0_1 + chooseC2_2 + chooseC3_3 + chooseC4_4
                                                        counts4Ptr[idx4_1 * n + score] += 1

                                                        let idx4_2 = chooseC0_1 + chooseC1_2 + chooseC3_3 + chooseC4_4
                                                        counts4Ptr[idx4_2 * n + score] += 1

                                                        let idx4_3 = chooseC0_1 + chooseC1_2 + chooseC2_3 + chooseC4_4
                                                        counts4Ptr[idx4_3 * n + score] += 1

                                                        let idx4_4 = chooseC0_1 + chooseC1_2 + chooseC2_3 + chooseC3_4
                                                        counts4Ptr[idx4_4 * n + score] += 1

                                                        // countsForTwoHeld (all 10 pairs)
                                                        counts2Ptr[(chooseC0_1 + chooseC1_2) * n + score] += 1
                                                        counts2Ptr[(chooseC0_1 + chooseC2_2) * n + score] += 1
                                                        counts2Ptr[(chooseC0_1 + chooseC3_2) * n + score] += 1
                                                        counts2Ptr[(chooseC0_1 + chooseC4_2) * n + score] += 1
                                                        counts2Ptr[(chooseC1_1 + chooseC2_2) * n + score] += 1
                                                        counts2Ptr[(chooseC1_1 + chooseC3_2) * n + score] += 1
                                                        counts2Ptr[(chooseC1_1 + chooseC4_2) * n + score] += 1
                                                        counts2Ptr[(chooseC2_1 + chooseC3_2) * n + score] += 1
                                                        counts2Ptr[(chooseC2_1 + chooseC4_2) * n + score] += 1
                                                        counts2Ptr[(chooseC3_1 + chooseC4_2) * n + score] += 1

                                                        // countsForThreeHeld (all 10 triples)
                                                        counts3Ptr[(chooseC0_1 + chooseC1_2 + chooseC2_3) * n + score] += 1
                                                        counts3Ptr[(chooseC0_1 + chooseC1_2 + chooseC3_3) * n + score] += 1
                                                        counts3Ptr[(chooseC0_1 + chooseC1_2 + chooseC4_3) * n + score] += 1
                                                        counts3Ptr[(chooseC0_1 + chooseC2_2 + chooseC3_3) * n + score] += 1
                                                        counts3Ptr[(chooseC0_1 + chooseC2_2 + chooseC4_3) * n + score] += 1
                                                        counts3Ptr[(chooseC0_1 + chooseC3_2 + chooseC4_3) * n + score] += 1
                                                        counts3Ptr[(chooseC1_1 + chooseC2_2 + chooseC3_3) * n + score] += 1
                                                        counts3Ptr[(chooseC1_1 + chooseC2_2 + chooseC4_3) * n + score] += 1
                                                        counts3Ptr[(chooseC1_1 + chooseC3_2 + chooseC4_3) * n + score] += 1
                                                        counts3Ptr[(chooseC2_1 + chooseC3_2 + chooseC4_3) * n + score] += 1

                                                        // countsForOneHeld
                                                        counts1Ptr[c0 * n + score] += 1
                                                        counts1Ptr[c1 * n + score] += 1
                                                        counts1Ptr[c2 * n + score] += 1
                                                        counts1Ptr[c3 * n + score] += 1
                                                        counts1Ptr[c4 * n + score] += 1
                                                    }
                                                }
                                            }
                                        }
