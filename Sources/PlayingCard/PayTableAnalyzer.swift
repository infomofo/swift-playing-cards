...
public enum PayTableAnalyzer {
    /// Precomputed reciprocals of completion counts indexed directly by hold mask (0...31) to avoid
    /// expensive popcount operations (`nonzeroBitCount`) in the inner evaluation loop.
