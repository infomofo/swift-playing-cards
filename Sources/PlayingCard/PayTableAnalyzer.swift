...
public enum PayTableAnalyzer {
    /// ⚡ Bolt Optimization: Precomputed reciprocals indexed directly by holdMask (0...31).
    /// This avoids calling `nonzeroBitCount` population count instructions and indirect
    /// double-array lookups on every mask in hot EV evaluation loops.
    private static let reciprocalCompletionsByMask: [Double] = (0 ... 31).map { mask in
    ...
    public static func overallReturn(payTable: PayTable) -> Double {
        ...
        reciprocalCompletionsByMask.withUnsafeBufferPointer { reciprocalBuf in
    ...
    private static func bestHoldEV(
        ...
        // ⚡ Bolt Optimization: Precalculate the 5 card binomial table row pointers once per hand
        // to avoid repeated multiplication by chooseTableStride inside the 32-mask loop.
        ...
        // ⚡ Bolt Optimization: Unroll the 80 Fast Möbius Transform (FMT) subtractions directly.
        // This eliminates loop counters, stepSize bitwise shifts, and dynamic offset calculations.
        // Step 0 (stepSize = 1)
        payoutOfSubset[0] -= payoutOfSubset[1]; payoutOfSubset[2] -= payoutOfSubset[3]
        payoutOfSubset[4] -= payoutOfSubset[5]; payoutOfSubset[6] -= payoutOfSubset[7]
        payoutOfSubset[8] -= payoutOfSubset[9]; payoutOfSubset[10] -= payoutOfSubset[11]
        payoutOfSubset[12] -= payoutOfSubset[13]; payoutOfSubset[14] -= payoutOfSubset[15]
        payoutOfSubset[16] -= payoutOfSubset[17]; payoutOfSubset[18] -= payoutOfSubset[19]
        payoutOfSubset[20] -= payoutOfSubset[21]; payoutOfSubset[22] -= payoutOfSubset[23]
        payoutOfSubset[24] -= payoutOfSubset[25]; payoutOfSubset[26] -= payoutOfSubset[27]
        payoutOfSubset[28] -= payoutOfSubset[29]; payoutOfSubset[30] -= payoutOfSubset[31]

        // Step 1 (stepSize = 2)
        payoutOfSubset[0] -= payoutOfSubset[2]; payoutOfSubset[1] -= payoutOfSubset[3]
        payoutOfSubset[4] -= payoutOfSubset[6]; payoutOfSubset[5] -= payoutOfSubset[7]
        payoutOfSubset[8] -= payoutOfSubset[10]; payoutOfSubset[9] -= payoutOfSubset[11]
        payoutOfSubset[12] -= payoutOfSubset[14]; payoutOfSubset[13] -= payoutOfSubset[15]
        payoutOfSubset[16] -= payoutOfSubset[18]; payoutOfSubset[17] -= payoutOfSubset[19]
        payoutOfSubset[20] -= payoutOfSubset[22]; payoutOfSubset[21] -= payoutOfSubset[23]
        payoutOfSubset[24] -= payoutOfSubset[26]; payoutOfSubset[25] -= payoutOfSubset[27]
        payoutOfSubset[28] -= payoutOfSubset[30]; payoutOfSubset[29] -= payoutOfSubset[31]

        // Step 2 (stepSize = 4)
        payoutOfSubset[0] -= payoutOfSubset[4]; payoutOfSubset[1] -= payoutOfSubset[5]
        payoutOfSubset[2] -= payoutOfSubset[6]; payoutOfSubset[3] -= payoutOfSubset[7]
        payoutOfSubset[8] -= payoutOfSubset[12]; payoutOfSubset[9] -= payoutOfSubset[13]
        payoutOfSubset[10] -= payoutOfSubset[14]; payoutOfSubset[11] -= payoutOfSubset[15]
        payoutOfSubset[16] -= payoutOfSubset[20]; payoutOfSubset[17] -= payoutOfSubset[21]
        payoutOfSubset[18] -= payoutOfSubset[22]; payoutOfSubset[19] -= payoutOfSubset[23]
        payoutOfSubset[24] -= payoutOfSubset[28]; payoutOfSubset[25] -= payoutOfSubset[29]
        payoutOfSubset[26] -= payoutOfSubset[30]; payoutOfSubset[27] -= payoutOfSubset[31]

        // Step 3 (stepSize = 8)
        payoutOfSubset[0] -= payoutOfSubset[8]; payoutOfSubset[1] -= payoutOfSubset[9]
        payoutOfSubset[2] -= payoutOfSubset[10]; payoutOfSubset[3] -= payoutOfSubset[11]
        payoutOfSubset[4] -= payoutOfSubset[12]; payoutOfSubset[5] -= payoutOfSubset[13]
        payoutOfSubset[6] -= payoutOfSubset[14]; payoutOfSubset[7] -= payoutOfSubset[15]
        payoutOfSubset[16] -= payoutOfSubset[24]; payoutOfSubset[17] -= payoutOfSubset[25]
        payoutOfSubset[18] -= payoutOfSubset[26]; payoutOfSubset[19] -= payoutOfSubset[27]
        payoutOfSubset[20] -= payoutOfSubset[28]; payoutOfSubset[21] -= payoutOfSubset[29]
        payoutOfSubset[22] -= payoutOfSubset[30]; payoutOfSubset[23] -= payoutOfSubset[31]

        // Step 4 (stepSize = 16)
        payoutOfSubset[0] -= payoutOfSubset[16]; payoutOfSubset[1] -= payoutOfSubset[17]
        payoutOfSubset[2] -= payoutOfSubset[18]; payoutOfSubset[3] -= payoutOfSubset[19]
        payoutOfSubset[4] -= payoutOfSubset[20]; payoutOfSubset[5] -= payoutOfSubset[21]
        payoutOfSubset[6] -= payoutOfSubset[22]; payoutOfSubset[7] -= payoutOfSubset[23]
        payoutOfSubset[8] -= payoutOfSubset[24]; payoutOfSubset[9] -= payoutOfSubset[25]
        payoutOfSubset[10] -= payoutOfSubset[26]; payoutOfSubset[11] -= payoutOfSubset[27]
        payoutOfSubset[12] -= payoutOfSubset[28]; payoutOfSubset[13] -= payoutOfSubset[29]
        payoutOfSubset[14] -= payoutOfSubset[30]; payoutOfSubset[15] -= payoutOfSubset[31]
