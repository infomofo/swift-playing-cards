...
public enum PayTableAnalyzer {
    ...
    /// and popcount operations in hot loops. Direct indexing by holdMask (0...31) completely
    /// eliminates 83.1 million `nonzeroBitCount` population count calls during EV evaluation.
